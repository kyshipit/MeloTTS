...
def unconstrained_rational_quadratic_spline(
    ...
    if tails == "linear":
        unnormalized_derivatives = F.pad(unnormalized_derivatives, pad=(1, 1),mode="constant", value=0.0)
    ...
    (
        outputs_inside_interval_mask, logabsdet_inside_interval_mask
    ...
    logabsdet = torch.add(logabsdet_inside_interval_mask, inside_interval_mask.float().int() * logabsdet)
